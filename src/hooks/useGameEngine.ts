...
export const useGameEngine = () => {
    ...
    useEffect(() => {
        if (gameState.isPlaying) {
            ...
            const spawnInterval = Math.max(baseInterval - levelReduction - scoreReduction, 200);
    ...
    }, [gameState.isPlaying, gameState.level, gameState.score, moveObjects, spawnObject]);
